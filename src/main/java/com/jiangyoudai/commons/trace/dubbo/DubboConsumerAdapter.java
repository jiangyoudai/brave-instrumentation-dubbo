...
public class DubboConsumerAdapter extends DubboAdapter<Invocation, Result> {
  ...
  public boolean parseServerAddress(Invocation invocation, Builder remoteEndpoint) {
    return false;
  }
}
